...
import ru.nsu.djachenko.logoworld.commands.Command;
...
public class CommandFactory
{
	...
	private void set(String name)
	{
		try
		{
			...
			if (Command.class.isAssignableFrom(currentCommand))//if this command can be cast to ru.nsu.djachenko.logoworld.Command
			{
